...
const SvgClockDuotone1 = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clock-duotone1_svg__a)">
      <path
        fill="#E84A4A"
    ...
    <defs>
      <clipPath id="clock-duotone1_svg__a">
        <path fill="#fff" d="M0 0h40v40H0z" />
      </clipPath>
    </defs>
  </svg>
)
export default SvgClockDuotone1
